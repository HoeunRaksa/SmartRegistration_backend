...
<body>
        ...
        <tbody>
            @foreach($registrations as $index => $reg)
                ...
                <tr>
                    ...
                    <td>{{ $reg->full_name_en ?? 'N/A' }}</td>
                    <td>
                        <span class="badge {{ $genderBadge }}">{{ $gender ?: 'N/A' }}</span>
                    </td>
    ...
    <div class="info-section">
        <div class="info-row">
            <span class="info-label">Payment Pending:</span> {{ $stats['payment_pending'] ?? 0 }} registrations
        </div>
        <div class="info-row">
            <span class="info-label">Payment Completed:</span> {{ $stats['payment_completed'] ?? 0 }} registrations
        </div>
        <div class="info-row">
