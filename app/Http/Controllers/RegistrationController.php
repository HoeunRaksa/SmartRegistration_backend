...
class RegistrationController extends Controller
{
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'profile_picture' => 'nullable|image|mimes:jpg,jpeg,png|max:10240', // ✅ 10MB limit
        ]);
        ...
        try {
            ...
            if ($request->hasFile('profile_picture')) {
                ...
                // Result: "profiles/abc123.jpg" (relative path only)
            }
            ...
            $registrationData = [
                ...
                // ✅ Profile Picture - stored in registration (path only)
            ...
            // ✅ Create student user account with profile picture
            $user = User::create([
                'name' => $fullNameEn,
                'email' => $request->personal_email,
                'password' => Hash::make($plainPassword),
                'role' => 'student',
                'profile_picture_path' => $profilePicturePath, // ✅ Same path in User table
            ]);

            // ✅ Create student record with profile picture
            $student = Student::create([
                ...
                'profile_picture_path' => $profilePicturePath, // ✅ Same path in Student table
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'user_id' => $user->id,
                    'profile_picture_path' => $profilePicturePath, // ✅ Return path only, not URL
                ],
                'student_account' => [
                    'email' => $user->email,
                    ...
                    'role' => 'student',
                    'student_code' => $student->student_code,
                    'profile_picture_path' => $profilePicturePath, // ✅ Return path only
                ]
            ], 201);
    ...
    // ✅ Get all registrations (return path only)
    public function index()
    {
        $registrations = DB::table('registrations')
            ...
            ->get();
        // ✅ No URL transformation - return paths as-is
    ...
    // ✅ Get single registration (return path only)
    public function show($id)
    {
        ...
        // ✅ No URL transformation - return path as-is
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'profile_picture' => 'nullable|image|mimes:jpg,jpeg,png|max:10240', // 10MB
        ]);
        ...
        try {
            ...
            if ($student) {
                ...
                // ✅ Update profile picture in student table
                if ($newProfilePicturePath) {
                    $studentUpdate['profile_picture_path'] = $newProfilePicturePath;
                }
                ...
                // ✅ Update profile picture in user table
            ...
            return response()->json([
                ...
                'profile_picture_path' => $newProfilePicturePath // ✅ Return path only
            ]);
    ...
    // ✅ Delete registration (cascade delete with profile picture cleanup)
